...
4. Wait for the image build and the post-create version checks to complete.
...
```dotenv
DATABASE_URL=postgresql://postgres:YOUR_URL_ENCODED_PASSWORD@host.docker.internal:5432/indexloom
DATASET_DATABASE_URL=postgresql://postgres:YOUR_URL_ENCODED_PASSWORD@host.docker.internal:5432/indexloom
```
